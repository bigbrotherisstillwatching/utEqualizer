...
//    color: Colors.backgroundColor
    ...
    Flickable {
        ...
        contentHeight: clmn1.height + txtfld1.height + txtfld2.height + txtfld3.height + txtfld4.height + txtfld5.height + txt3.height + units.gu(90)
                    ...
                    Qqc.Slider {
                        ...
                        background: Rectangle {
                            ...
                            Rectangle {
                                ...
                                color: settings.darkMode ? "#808080" : "#d4d4d4"
                                radius: 2
                                border.width: 0
                            }
                        }
                        handle: Rectangle {
                            ...
                            border.color: settings.darkMode ? "#808080" : "#d4d4d4"
                            border.width: 4
                        }
                    }
                    Label {
